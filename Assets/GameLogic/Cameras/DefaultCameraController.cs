...
using KS = Assets.GameLogic.HWInput.InputKeyState;
...
namespace Assets.GameLogic.Cameras
{
    ...
    public class DefaultCameraController : _BaseCameraController
    {
        ...
        [Range(0f, 100)]
        [Header("Velocity")]
        public float Move_Speed_PerFrame = 0.01f;
        ...
        /// <summary>
        /// ToDo: Split this logic so that camera position is calculated in Update(), and actual camera transforms are updated in LateUpdate()
        /// </summary>
        public override void UpdateCamera()
        {
            ...
            {
                //Move Forward
                this.Acceleration_ThisFrame += this.transform.forward.normalized * this.Move_Speed_PerFrame;
            }
            ...
            {
                //Move Right
                this.Acceleration_ThisFrame += this.transform.right.normalized * this.Move_Speed_PerFrame;
            }
            ...
            {
                //Move Up
                this.Acceleration_ThisFrame += this.transform.up.normalized * this.Move_Speed_PerFrame;
            }
        ...
        {
            if (this.Velocity_Current.sqrMagnitude > Velocity_Max * Velocity_Max)
                this.Velocity_Current = Vector3.ClampMagnitude(this.Velocity_Current, Velocity_Max);
        }
